...
export const reservationHotel = pgTable('reservationHotel', {
  id: uuid('id').primaryKey().defaultRandom(),
  propertyId: uuid('propertyId')
    .references(() => propertyHotel.id)
    .notNull(),
...
export type ReservationHotel = typeof reservationHotel
export type ReservationHotelFields = typeof reservationHotel.$inferSelect
