...
export const estate = pgTable('estate', {
  ...
  hasTv: boolean('hasTv').default(true),
  hasNetflix: boolean('hasNetflix').default(true),
  hasHeat: boolean('hasHeat').default(false),
  hasAc: boolean('hasAc').default(false),
  hasIron: boolean('hasIron').default(false),
  hasDesk: boolean('hasDesk').default(false),
  hasKitchen: boolean('hasKitchen').default(true),
