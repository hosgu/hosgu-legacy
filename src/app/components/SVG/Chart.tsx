...
const SVG: FC<Props> = ({ className = 'h-6 w-6', label = undefined, onClick = undefined }) => (
  ...
  Z"
      />
      <rect fill="#333333" x="384.76" y="119.08" width="89.94" height="243.56" rx="0.26" />
      <rect fill="#333333" x="168.80" y="156.49" width="90.10" height="206.14" rx="0.74" />
      <rect fill="#333333" x="276.76" y="180.85" width="89.98" height="181.78" rx="0.74" />
      <rect fill="#333333" x="60.86" y="212.55" width="90.04" height="150.10" rx="0.41" />
      <rect fill="#333333" x="60.84" y="376.78" width="413.92" height="15.74" rx="0.66" />
    </svg>
  </div>
)
